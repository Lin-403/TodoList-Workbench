export const PlusIcon = () => (<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="white" fillOpacity="0.01"/><path d="M24.0607 10L24.024 38" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/><path d="M10 24L38 24" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/></svg>)

export const ListIcon = () => (<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="6" width="40" height="36" rx="3" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/><path d="M4 14H44" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/><path d="M20 24H36" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/><path d="M20 32H36" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 24H14" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 32H14" stroke="#314ec3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/></svg>)
